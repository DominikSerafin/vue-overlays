...
"use strict";
eval("Object.defineProperty(exports,\"__esModule\",{value:true});exports.default=void 0;var _Portal=_interopRequireDefault(__webpack_require__(/*! ./Portal.js */ \"./src/Portal.js\"));var _Backdrop=_interopRequireDefault(__webpack_require__(/*! ./Backdrop.js */ \"./src/Backdrop.js\"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var modalStyles={display:'flex',width:'100%',height:'100%',position:'fixed',//zIndex: theme.zIndex.modal,\nzIndex:1300,top:0,left:0};var hiddenStyles={visibility:'hidden'};var _default={props:{open:{type:Boolean,default:false},hideBackdrop:{type:Boolean,default:false}},data:function data(){return{};},computed:{},watch:{},mounted:function mounted(){},updated:function updated(){},beforeDestroy:function beforeDestroy(){},methods:{},render:function render(h){if(!this.$props.open)return null;var style=this.$props.hideBackdrop?Object.assign(modalStyles,hiddenStyles):modalStyles;var modal=h('div',{style:style,ref:'modal'},this.$slots.default);if(this.$props.hideBackdrop){var backdrop=null;}else{var backdrop=h('Backdrop',{attrs:{open:this.$props.open},ref:'backdrop'});}var portal=h('Portal',{ref:'portal'},[modal,backdrop]);return portal;}};exports.default=_default;\n\n//# sourceURL=webpack:///./src/Modal.js?");
