...
"use strict";
eval("Object.defineProperty(exports,\"__esModule\",{value:true});exports.default=void 0;var _contains=_interopRequireDefault(__webpack_require__(/*! ./util/dom-helpers/query/contains */ \"./src/util/dom-helpers/query/contains.js\"));var _ownerDocument=_interopRequireDefault(__webpack_require__(/*! ./util/dom-helpers/ownerDocument */ \"./src/util/dom-helpers/ownerDocument.js\"));var _debounce=_interopRequireDefault(__webpack_require__(/*! ./util/debounce */ \"./src/util/debounce.js\"));var _ownerWindow=_interopRequireDefault(__webpack_require__(/*! ./util/ownerWindow */ \"./src/util/ownerWindow.js\"));var _warning=_interopRequireDefault(__webpack_require__(/*! ./util/warning */ \"./src/util/warning.js\"));var _extend=_interopRequireDefault(__webpack_require__(/*! ./util/extend */ \"./src/util/extend.js\"));var _cloneWithoutReactivity=_interopRequireDefault(__webpack_require__(/*! ./util/cloneWithoutReactivity */ \"./src/util/cloneWithoutReactivity.js\"));var _Modal=_interopRequireDefault(__webpack_require__(/*! ./Modal.js */ \"./src/Modal.js\"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getOffsetTop(rect,vertical){var offset=0;if(typeof vertical==='number'){offset=vertical;}else if(vertical==='center'){offset=rect.height/2;}else if(vertical==='bottom'){offset=rect.height;}return offset;}function getOffsetLeft(rect,horizontal){var offset=0;if(typeof horizontal==='number'){offset=horizontal;}else if(horizontal==='center'){offset=rect.width/2;}else if(horizontal==='right'){offset=rect.width;}return offset;}function getTransformOriginValue(transformOrigin){return[transformOrigin.horizontal,transformOrigin.vertical].map(function(n){return typeof n==='number'?\"\".concat(n,\"px\"):n;}).join(' ');}// Sum the scrollTop between two elements.\nfunction getScrollParent(parent,child){var element=child;var scrollTop=0;while(element&&element!==parent){element=element.parentNode;scrollTop+=element.scrollTop;}return scrollTop;}function getAnchorEl(anchorEl){return typeof anchorEl==='function'?anchorEl():anchorEl;}var popoverStyles=function popoverStyles(){// paper:\nreturn{position:'absolute',overflowY:'auto',overflowX:'hidden',// So we see the popover when it's empty.\n// It's most likely on issue on userland.\nminWidth:10,minHeight:10,maxWidth:'calc(100% - 20px)',maxHeight:'calc(100% - 20px)',// We disable the focus ring for mouse, touch and keyboard users.\noutline:'none'};};var _default2={name:'Popover',props:{modalProps:{type:Object,default:function _default(){return{};}},popoverStyle:{},transformOrigin:{default:function _default(){return{vertical:'top',horizontal:'left'};}},anchorEl:{},anchorOrigin:{default:function _default(){return{vertical:'top',horizontal:'left'};}},getContentAnchorEl:{},anchorReference:{default:'anchor-el'},anchorPosition:{},marginThreshold:{default:10}},data:function data(){return{};},computed:{},watch:{},mounted:function mounted(){this.setPositioningStyles(this.$refs.popover);var win=(0,_ownerWindow.default)(this.$refs.popover);win.addEventListener('resize',this.handleResize,false);},updated:function updated(){},beforeDestroy:function beforeDestroy(){var win=(0,_ownerWindow.default)(this.$refs.popover);win.removeEventListener('resize',this.handleResize,false);},methods:{handleCloseRequest:function handleCloseRequest(event,source){this.$emit('close',event,source);},setPositioningStyles:function setPositioningStyles(element){if(element&&element.style){var positioning=this.getPositioningStyle(element);if(positioning.top!==null){element.style.top=positioning.top;}if(positioning.left!==null){element.style.left=positioning.left;}element.style.transformOrigin=positioning.transformOrigin;}},getPositioningStyle:function getPositioningStyle(element){var anchorEl=this.$props.anchorEl;var anchorReference=this.$props.anchorReference;var marginThreshold=this.$props.marginThreshold;// Check if the parent has requested anchoring on an inner content node\nvar contentAnchorOffset=this.getContentAnchorOffset(element);var elemRect={width:element.clientWidth,height:element.clientHeight};// Get the transform origin point on the element itself\nvar transformOrigin=this.getTransformOrigin(elemRect,contentAnchorOffset);// return right away nothing if none is set as reference (will make popover stick to top left)\nif(anchorReference==='none'){return{top:null,left:null,transformOrigin:getTransformOriginValue(transformOrigin)};}// Use the parent window\nvar containerWindow=(0,_ownerWindow.default)(getAnchorEl(anchorEl));// Window thresholds taking required margin into account\nvar heightThreshold=containerWindow.innerHeight-marginThreshold;var widthThreshold=containerWindow.innerWidth-marginThreshold;// Get the offset of of the anchoring element\nvar anchorOffset=this.getAnchorOffset(contentAnchorOffset);// Calculate element positioning\nvar top=anchorOffset.top-transformOrigin.vertical;var left=anchorOffset.left-transformOrigin.horizontal;var bottom=top+elemRect.height;var right=left+elemRect.width;// Check if the vertical axis needs shifting\nif(top<marginThreshold){var diff=top-marginThreshold;top-=diff;transformOrigin.vertical+=diff;}else if(bottom>heightThreshold){var _diff=bottom-heightThreshold;top-=_diff;transformOrigin.vertical+=_diff;}(0,_warning.default)(elemRect.height<heightThreshold||!elemRect.height||!heightThreshold,['Vue-Overlays: the popover component is too tall.',\"Some part of it can not be seen on the screen (\".concat(elemRect.height-heightThreshold,\"px).\"),'Please consider adding a `max-height` to improve the user-experience.'].join('\\n'));// Check if the horizontal axis needs shifting\nif(left<marginThreshold){var _diff2=left-marginThreshold;left-=_diff2;transformOrigin.horizontal+=_diff2;}else if(right>widthThreshold){var _diff3=right-widthThreshold;left-=_diff3;transformOrigin.horizontal+=_diff3;}return{top:\"\".concat(top,\"px\"),left:\"\".concat(left,\"px\"),transformOrigin:getTransformOriginValue(transformOrigin)};},// Returns the top/left offset of the position\n// to attach to on the anchor element (or body if none is provided)\ngetAnchorOffset:function getAnchorOffset(contentAnchorOffset){var anchorEl=this.$props.anchorEl;var anchorOrigin=this.$props.anchorOrigin;var anchorReference=this.$props.anchorReference;var anchorPosition=this.$props.anchorPosition;if(anchorReference==='anchor-position'){(0,_warning.default)(anchorPosition,'Vue-Overlays: you need to provide a `anchor-position` property when using '+'<Popover anchor-reference=\"anchor-position\" />.');return anchorPosition;}// if reference is element...\n// if an anchor element wasn't provided, just use the parent body element of this Popover\nvar anchorElement=getAnchorEl(anchorEl)||(0,_ownerDocument.default)(this.$refs.popover).body;var anchorRect=anchorElement.getBoundingClientRect();var anchorVertical=contentAnchorOffset===0?anchorOrigin.vertical:'center';return{top:anchorRect.top+this.handleGetOffsetTop(anchorRect,anchorVertical),left:anchorRect.left+this.handleGetOffsetLeft(anchorRect,anchorOrigin.horizontal)};},// Returns the vertical offset of inner content to anchor the transform on if provided\ngetContentAnchorOffset:function getContentAnchorOffset(element){var anchorOrigin=this.$props.anchorOrigin;var getContentAnchorEl=this.$props.getContentAnchorEl;var anchorReference=this.$props.anchorReference;var contentAnchorOffset=0;if(getContentAnchorEl&&anchorReference==='anchor-el'){var contentAnchorEl=getContentAnchorEl(element);if(contentAnchorEl&&(0,_contains.default)(element,contentAnchorEl)){var scrollTop=getScrollParent(element,contentAnchorEl);contentAnchorOffset=contentAnchorEl.offsetTop+contentAnchorEl.clientHeight/2-scrollTop||0;}// != the default value\n(0,_warning.default)(anchorOrigin.vertical==='top',['Vue-Overlays: you can not change the default `anchorOrigin.vertical` value ','when also providing the `getContentAnchorEl` property to the popover component.','Only use one of the two properties.','Set `getContentAnchorEl` to null or left `anchorOrigin.vertical` unchanged.'].join('\\n'));}return contentAnchorOffset;},// Return the base transform origin using the element\n// and taking the content anchor offset into account if in use\ngetTransformOrigin:function getTransformOrigin(elemRect,contentAnchorOffset){if(typeof contentAnchorOffset==='undefined'){var contentAnchorOffset=0;}var transformOrigin=this.$props.transformOrigin;return{vertical:this.handleGetOffsetTop(elemRect,transformOrigin.vertical)+contentAnchorOffset,horizontal:this.handleGetOffsetLeft(elemRect,transformOrigin.horizontal)};},handleGetOffsetTop:getOffsetTop,handleGetOffsetLeft:getOffsetLeft,handleResize:(0,_debounce.default)(function(){this.setPositioningStyles(this.$refs.popover);},166),// Corresponds to 10 frames at 60 Hz.\nmakePopoverStyle:function makePopoverStyle(){var defaults=popoverStyles();var final=defaults;if(this.$props.popoverStyle){// order is important: default styles always overwrite custom ones\nfinal=Object.assign(this.$props.popoverStyle,defaults);}return final;}},render:function render(h){var popoverStyle=this.makePopoverStyle();var popover=h('div',{ref:'popover',style:popoverStyle},[this.$slots.default]);var finalModalProps=(0,_extend.default)({backdropInvisible:true},(0,_cloneWithoutReactivity.default)(this.$props.modalProps));var modal=h('Modal',{ref:'modal',attrs:finalModalProps,on:{'close':this.handleCloseRequest}},[popover]);return modal;//var wrapper = h('div', {\n//  ref: 'wrapper',\n//}, [popover]);\n//return wrapper;\n}};exports.default=_default2;\n\n//# sourceURL=webpack:///./src/Popover.js?");
...
"use strict";
eval("Object.defineProperty(exports,\"__esModule\",{value:true});exports.default=void 0;var _Portal=_interopRequireDefault(__webpack_require__(/*! ./Portal.js */ \"./src/Portal.js\"));var _Backdrop=_interopRequireDefault(__webpack_require__(/*! ./Backdrop.js */ \"./src/Backdrop.js\"));var _Modal=_interopRequireDefault(__webpack_require__(/*! ./Modal.js */ \"./src/Modal.js\"));var _ModalManager=_interopRequireDefault(__webpack_require__(/*! ./ModalManager.js */ \"./src/ModalManager.js\"));var _Popover=_interopRequireDefault(__webpack_require__(/*! ./Popover.js */ \"./src/Popover.js\"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}try{window.vo={Portal:_Portal.default,Backdrop:_Backdrop.default,Modal:_Modal.default,ModalManager:_ModalManager.default,Popover:_Popover.default};}catch(e){console.error(e);}var _default={Portal:_Portal.default,Backdrop:_Backdrop.default,Modal:_Modal.default,ModalManager:_ModalManager.default,Popover:_Popover.default};exports.default=_default;\n\n//# sourceURL=webpack:///./src/index.js?");

/***/ }),

/***/ "./src/util/cloneWithoutReactivity.js":
/*!********************************************!*\
  !*** ./src/util/cloneWithoutReactivity.js ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("Object.defineProperty(exports,\"__esModule\",{value:true});exports.default=cloneWithoutReactivity;function cloneWithoutReactivity(obj){return JSON.parse(JSON.stringify(obj));}\n\n//# sourceURL=webpack:///./src/util/cloneWithoutReactivity.js?");
